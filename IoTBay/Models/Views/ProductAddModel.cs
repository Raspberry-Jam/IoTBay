...
public class ProductAddModel : IValidatableObject
{
    ...
    [Required] public required string Type { get; set; } // This will hold the selected category (e.g. name or ID)
    ...
    [Required] public required string ShortDescription { get; set; }
